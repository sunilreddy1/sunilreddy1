...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Health Care Chatbot", bg="red",fg="yellow", width="300", height="2", font=("Stencil", 28))
        self.lblMsg.pack()
        ...
        self.lblTeam=Label(self, text="MADE BY:", bg="orange", width = "250", height = "1", font=("Elephant", 13))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="SUNIL KUMAR G P", fg="blue", width = "250", height = "1", font=("Algerian", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="MANASA G B", fg="blue", width = "250", height = "1", font=("Algerian", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="| | | | | | | | | | | | | |", bg="GREEN", width = "250", height = "1", font=("Elephant", 13))
        self.lblTeam3.pack()
